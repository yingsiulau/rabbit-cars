    ...
    <div className="bg-background text-foreground min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        ...
        <p className="mt-16 text-xs text-muted-foreground text-center max-w-[60ch] mx-auto">
          Angaben ohne Gewähr · Preise in CHF · Datenbestand als statische Vorlage.
          Anbindung an den Live-Feed von AutoScout24 folgt sobald die API-Zugangsdaten hinterlegt sind.
        </p>
      </section>
    </div>
  );
